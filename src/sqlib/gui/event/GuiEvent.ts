module SQ {
    export class GuiEvent extends egret.Event {
        public static STRADIO_CHANGESTATUS:string = "stradio_changestatus";

        public static STRADIOGROUP_RADIO_SELECTEDINDEX:string = "stradiogroup_radio_selectedindex";
        public static Slider_CHANGE_VALUE:string = "slider_change_value";
